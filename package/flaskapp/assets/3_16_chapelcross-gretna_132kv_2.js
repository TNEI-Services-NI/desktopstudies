...
networks_undrawn["chapelcrossgretna2"]={
    ...
    dataViews:{
        "CHAP2-_GRNA1#": new DataView("205 203_2",[-50,-20], ["lines_active_power","lines_reactive_power","lines_current"]),
        "CHAP2-_GRNA1": new DataView("GRNA1-#0",[60,-40], ["lines_active_power","lines_reactive_power","lines_current"]),


        "GRNA1-#0": new DataView("GRNA1-#1",[-50,-20], ['busbars_voltage']),
        "CHAP1-_R1-_1": new DataView("CHAP1-_R1-_1", [-50,-20], ["busbars_voltage"]),
        "CHAP1-": new DataView("CHAP1-_M1-_1",[-50,20], ["busbars_voltage"]),
    },
