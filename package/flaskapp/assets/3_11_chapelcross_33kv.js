...
networks_undrawn["chapelcross33kv"] = {
    ...
    breakers:{
        ...
        "698 14": new Breaker("ANANT1_CHAP3-_1#1",0.19,"closed"),
    ...
    dataViews:{
        ...
        "398 26": new DataView(880,230, "GRID 1",["Amps"]),
        "398 25": new DataView(820,230, "GRID 1",["Amps"]),
        "398 24": new DataView(760,230,"GRID 1", ["Amps"]),
