...
networks_undrawn["chapelcross132kv"]={
    ...
    "CHAP1-_R1#0": StraightLine([865,370],"down",50,"132kV"),
    ...
    "CHAP1-_R1#1": StraightLine([785,370],"down",50,"132kV"),
    ...
    "CHAP1-_R1#2": StraightLine([700,370],"down",150,"132kV"),
        "CHAP1-_R1#3":StraightLine([740,470],"left",40, "132kV"),
        "CHAP1-_R1#4": StraightLine([740,470],"up",145, "132kV"),
    "ECCF-2": StraightLine([740,325],"up",145, "132kV"),

    "CHAP1-_R1#5": StraightLine([625,370],"down",50,"132kV"),
    ...
    "CHAP1-_R1#6": StraightLine([555,370],"down",150,"132kV"),
    "CHAP1-_M1-_2#10": StraightLine([555,520],"down",50,"132kV"),
    "CHAP1-_R1#7":StraightLine([595,470],"left",40, "132kV"),
    "CHAP1-_R1#8": StraightLine([595,470],"up",145, "132kV"),
    "GRNA-2": StraightLine([595,325],"up",145, "132kV"),

    "CHAP1-_R1#9": StraightLine([400,370],"down",100,"132kV"),
    "CHAP1-_M1-_1#12": StraightLine([400,470],"down",100,"132kV"),

    "CHAP1-_R1#10": StraightLine([320,370],"down",50,"132kV"),
    ...
    "CHAP1-_R1#11": StraightLine([240,370],"down",50,"132kV"),
    ...
    "CHAP1-_R1#12": StraightLine([150,370],"down",50,"132kV"),
    ...
    "CHAP1-_R1#13": StraightLine([65,370],"down",50,"132kV"),
    ...
    "CHAP1-_R1": StraightLine([35,370],"right",905,"132kV"),
...
//
        ...
        "205": new Breaker("CHAP1-_R1#8",1),
        "615": new Breaker("CHAP1-_R1#4",1),
...
//
        ...
        "206": new Isolator("CHAP1-_R1#6",0.33,"closed"),
        "204": new Isolator("CHAP1-_R1#6",1,"open"),
        "416": new Isolator("CHAP1-_M1-_2#7",0,"open"),
        "414": new Isolator("CHAP1-_M1-_2#7",0.66,"closed"),

        "613": new Isolator("ECCF-2",0.3,"closed"),
        "616": new Isolator("CHAP1-_R1#2",0.33,"closed"),
        "614": new Isolator("CHAP1-_R1#2",1,"open"),
        ...
        "126": new Isolator("CHAP1-_R1", 0.45,"closed"),
        "129": new Isolator("CHAP1-_R1", 0.55,"closed"),

        "336": new Isolator("CHAP1-_R1#9", 0.55, "closed"),
...
//    },
    ...
    5: new Text("CHAP1-_R1",["R1"],[-470,0]),
    6: new Text("CHAP1-_R1",["132kV"],[-10,90]),
    7: new Text("CHAP1-_R1",["(SPD)"],[-10,105]),
//
    ...
    15: new Text("CHAP1-_R1",["CHAPELCROSS 132kV"],[0,-350]),
    },
//
    generationInfo:{
